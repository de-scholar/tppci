...
export default function (state = initialState, action) {
  switch (action.type) {
    ...
    case ADD_NEW_APPLICATION_FORM:
      return {
        ...state, appAddInfo: action.payload,
      };
    case ADD_NEW_USER:
      return {
        ...state, userAddInfo: action.payload,
      };
    case CHECK_IF_EMAIL_EXISTS_FROM_APPLICATIOS:
      return {
        ...state, isEmailExistsFromApplications: action.payload,
      };
